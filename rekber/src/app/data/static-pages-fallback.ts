// Fallback content used ONLY if the CMS API (rekber_api /api/static-pages/:slug)
// is unreachable. Mirrors the content seeded into the static_pages table so the
// 4 pages below never render blank if the backend is down.
import type { StaticPage } from "../components/static-pages/types"

export const STATIC_PAGES_FALLBACK: Record<string, StaticPage> = {
  "tentang-kami": {
    slug: "tentang-kami",
    page_type: "about",
    title: "Tentang Kami",
    meta_description: "Pelajari visi, misi, dan tim di balik layanan rekening bersama Rekber.com.",
    ...
    content: {
      ...
      mission: {
        ...
        points: [
          { title: "Keamanan Terjamin", description: "Sistem enkripsi tingkat bank untuk melindungi data dan transaksi" },
          { title: "Transparansi Penuh", description: "Proses yang jelas dan dapat dilacak di setiap tahap transaksi" },
          { title: "Dukungan 24/7", description: "Tim customer service siap membantu kapan saja" },
        ],
      },
  ...
  "syarat-dan-ketentuan": {
    ...
    meta_description: "Syarat dan ketentuan penggunaan layanan rekening bersama Rekber.com.",
    updated_at: "2025-01-15T00:00:00.000Z",
    content: {
      intro:
  ...
  "syarat-dan-ketentuan-kyc": {
    ...
    meta_description: "Syarat dan ketentuan proses verifikasi identitas (KYC) di Rekber.com.",
